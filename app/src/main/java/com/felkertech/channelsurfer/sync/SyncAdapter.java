...
public class SyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    public void doLocalSync() {
        ...
        List<Channel> allChannels = LibraryUtils.getTvInputProvider(mContext).getAllChannels();
        ...
        for (int i = 0; i < channelMap.size(); ++i) {
            ...
            List<Program> programList = LibraryUtils.getTvInputProvider(mContext).getProgramsForChannel(channelUri, channelMap.valueAt(i), startMs, endMs);
